...
export type ApiWorkflowVideoProps = {actions: WorkflowAction[]; fps?: 30|60};
...
export const calculateApiWorkflowMetadata = ({props}:{props:ApiWorkflowVideoProps}) => {const fps=props.fps??30;return {durationInFrames:Math.max(1,Math.round(props.actions.reduce((sum,a)=>sum+a.duration,0)*fps)),fps,width:824,height:1830};};
