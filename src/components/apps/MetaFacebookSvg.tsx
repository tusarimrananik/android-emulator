...
// 1. HOME TAB (Meta SVG 4) - Facebook Blue (#0866FF) when active, Slate Grey (#65676B) when inactive
export const MetaNavHomeIcon: React.FC<{ active?: boolean; size?: number }> = ({ active = false, size = 26 }) => (
  <svg viewBox="0 0 24 24" width={size} height={size} fill={active ? '#0866FF' : '#65676B'} style={{ color: active ? '#0866FF' : '#65676B' }}>
...
// 4. NOTIFICATIONS TAB (Meta SVG 11) - Meta Slate Grey (#65676B) when inactive, Blue (#0866FF) when active
